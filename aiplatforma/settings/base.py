...
MIDDLEWARE = [
    ...
    # Right after SecurityMiddleware: a www request is redirected before any
    # session, CSRF or static-file work is done for it.
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@buildflow.local")
